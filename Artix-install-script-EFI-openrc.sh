...
basestrap /mnt base base-devel openrc elogind-openrc		//Install a couple of essential packages
...
cp Artix-quick-install-script-EFI-openrc-pt2.sh /mnt/		//Copy the second part of the install script to the new install
